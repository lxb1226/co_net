...
using MessageCallback =
    std::function<void(const TcpConnectionPtr &, IBuffer &, Timestamp)>;

// using CoConnEstablishCallback = std::function<void(const
// CoTcpConnectionPtr&)>;
...
void defaultMessageCallback(const TcpConnectionPtr &conn, IBuffer &buffer,
